...
<p class="text-slate-600 leading-relaxed">JSON-Code im vorgesehenen Format einfügen. Informationen zum Prompt findet ihr <a href="/faq" class="text-blue-600 underline hover:no-underline cursor-pointer font-semibold">hier</a>, oder ihr könnt den Test-Prompt importieren.</p>
